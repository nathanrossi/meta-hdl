...
SRCREV = "e9c583109736b03e7f7107645f156de943cb530a"
...
do_compile () {
    ...
    sed -i 's#HX8KBOARD#HX8KDEMO#' ${S}/firmware.c

    oe_runmake -f ${S}/Makefile hx8kdemo.bin
    oe_runmake -f ${S}/Makefile hx8kdemo_fw.bin
}

do_deploy () {
    install -Dm 0644 ${B}/hx8kdemo.bin ${DEPLOYDIR}/picosoc-hx8k.bin
    install -Dm 0644 ${B}/hx8kdemo_fw.bin ${DEPLOYDIR}/firmware.bin
}
